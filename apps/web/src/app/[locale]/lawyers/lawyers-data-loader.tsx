...
interface LawyersDataLoaderProps {
  lawyers: Lawyer[];
  cases: Case[];
}
 ...
 * Used to populate contexts when navigating directly to lawyers page
 * or when switching languages
 */
const LawyersDataLoader = ({ lawyers, cases }: LawyersDataLoaderProps) => {
...
export default LawyersDataLoader;
